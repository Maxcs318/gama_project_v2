<template>
  <div class="container">
    ...
    <!-- <img src="./../../../../public/assets/logo_img/search.png" alt=""> -->
    <div class="row" v-if="the_user">
      ...
      <div class="col-lg-6 col-12">
        ...
        <input
          ...
          class="form-control"
          v-model="searching"
          placeholder="ค้นหา จากวารสารออนไลน์ทั้งหมด ที่สามารถเข้าถึงได้"
        />
      ...
      <div class="col-lg-12 col-xs-12">
        <table class="table" style="width:100%">
          <tr style="width:100%">
            ...
            <th style="width:55%">ชื่อ วารสารออนไลน์</th>
          ...
          <tr v-for="(online_journal,index) in the_online_journal" :key="index">
            ...
            <td>
              <button
                ...
                @click="seethis_online_journal(online_journal.oj_id)"
              >
              ดูเพิ่มเติม
                <!-- <img :src="path_files+'logo_img/research.png'" width="50%" /> -->
              </button>
            </td>
          </tr>
        </table>
...
export default {
  ...
  methods: {
    ...
    seethis_online_journal(this_online_journal) {
      this.$router.push({
        name: "online_journal",
        params: { Online_JournalID: this_online_journal }
      });
    }
  },
  watch: {
        ...
        axios
          .get(
            this.$store.getters.getBase_Url +
              "Online_Journal/get_all_online_journal_like/" +
              this.permission +
              "/" +
              search
          )
  ...
  computed: {
    ...
    the_user() {
      ...
      if (user == "" || user == null || user == undefined) {
        setTimeout(() => {
          this.text_alert =
            "วารสารออนไลน์ จะไม่แสดงหากไม่มีการ Login เข้าสู่ระบบ";
        }, 1000);
      }
      return user;
    },
    the_online_journal() {
      ...
      if (this.data_load == false) {
        axios
          .get(
            this.$store.getters.getBase_Url +
              "Online_Journal/get_online_journal/" +
              this.data_in_page +
              "/" +
              this.permission +
              "/" +
