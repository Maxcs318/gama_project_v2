<template>
  <div class="container" >
    ...
    <br />
    <div class="row" v-if="Award_year_All!=''">
      <div class="col-lg-3 col-xs-12">
        <button class="form-control btn-primary" @click="company">บริษัท</button>
        <br />
      </div>
      <div class="col-lg-3 col-xs-12">
        <button class="form-control btn-primary" @click="award_types">ประเภทรางวัล</button>
        <br />
      </div>
      <div class="col-lg-3 col-xs-12">
...
export default {
  ...
  computed: {
    the_award_list() {
      ...
      // console.log(year_all)
      if(this.$route.params.AwardYear =='now'&& this.Award_year_All && this.data_load_award_year == true){
        var find_last_year = (year_all.length)-1 ;
        var now_year = null;
         now_year = this.Award_year_All[find_last_year]
          // console.log('now',this.Award_year_All)
