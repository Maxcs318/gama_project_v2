<template>
  <div class="container">
    <center>
      <h4 class="header">แก้ไข บทความ</h4>
    </center>
    <div class="row mt-5" v-if="thisArticle && the_user">
      ...
      <div class="col-lg-8 col-xs-12">
        ...
        <form @submit.prevent="submitArticle">
          ...
          ></textarea>
          <br />
          <div v-if="article_data_file != null" v-for="(file,run) in article_data_file">
...
export default {
  ...
  computed: {
    ...
    thisArticle() {
      var articlesID = this.$route.params.ArticleID
      if(this.data_load==false){
        axios.get(this.$store.getters.getBase_Url+'Article/get_this_article/'+articlesID)
        .then(response => {
      ...
      if(this.check_delete_file == false){
        this.articleE = this.article_data
      }
      return article_show;
    },
    article_category() {
