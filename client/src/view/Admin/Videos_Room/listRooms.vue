            ...
            <div class="col-lg-12 col-md-12">
                <table class="table" style="width:100%" >
                    ...
                    <tr v-for="(list,index) in ListRoom" :key="index" >
                        ...
                        <td> <button class="form-control btn-success" @click="seethisRoom(list.vr_id)">เข้าห้อง</button> </td>
                        <td> <button class="form-control btn-warning" @click="editRoom(list.vr_id)">แก้ไข</button> </td>
                        <td> <button class="form-control btn-danger" @click="deleteRoom(list.vr_id)">ลบ</button> </td>
                    </tr>
                </table>
            </div>
        </div>
