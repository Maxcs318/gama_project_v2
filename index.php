...
// } elseif (isset($uri[1]) && $uri[1] === APP_BACKEND) {
//     $_SERVER['REQUEST_URI'] = str_replace(APP_BACKEND . '/', '', $_SERVER['REQUEST_URI']);
//     $_SERVER['REQUEST_URI'] = str_replace(APP_BACKEND, '', $_SERVER['REQUEST_URI']);
//     $application_folder = '../' . APP_BACKEND;
// } else {
    $_SERVER['REQUEST_URI'] = str_replace(APP_VUE . '/', '', $_SERVER['REQUEST_URI']);
    $_SERVER['REQUEST_URI'] = str_replace(APP_VUE, '', $_SERVER['REQUEST_URI']);
    $application_folder = './' . APP_VUE;
// }
